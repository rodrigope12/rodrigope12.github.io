...
PROMPT = (
    "Analiza la imagen como una pregunta de examen, reactivo o ejercicio. "
    "Si la captura contiene varias preguntas, varios reactivos o varios incisos, responde TODOS en el mismo orden en que aparecen en la imagen. "
    "Devuelve exclusivamente las respuestas finales correctas y nada mas. "
    "Usa una respuesta por linea cuando haya mas de una. "
    "Si la pregunta muestra opciones etiquetadas con letras como A, B, C, D, E o F, devuelve unicamente la LETRA de la opcion correcta. "
    "Si la pregunta muestra opciones numeradas, devuelve unicamente el NUMERO correcto. "
    "Si la respuesta correcta es SI o NO, devuelve solo SI o solo NO. "
    "Solo si NO existen opciones etiquetadas con letras o numeros, devuelve la palabra o frase correcta exacta. "
    "Nunca devuelvas el texto de una opcion si esa opcion tiene letra o numero asociado; devuelve solo la letra o el numero. "
    "No expliques, no justifiques, no repitas el enunciado, no agregues encabezados, no numeres las respuestas, no agregues texto extra, no agregues puntuacion, no agregues comillas."
)
